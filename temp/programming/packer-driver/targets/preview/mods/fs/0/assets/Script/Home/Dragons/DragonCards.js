    ...
    execute: function () {
      ...
      _export("DragonCards", DragonCards = (_dec = ccclass('DragonCards'), _dec2 = property({
        ...
        setSelectedDragon(index) {
          ...
          var image = this.dragonCards[index].getChildByName('DragonImage').getComponent(Sprite).spriteFrame;
        ...
        start() {
          this.backButton();
          var tempNode = null; //    for(let i=0;i<this.AvailableDragons;i++)
          //    {
          ...
          var index = (_crd && TeamManager === void 0 ? (_reportPossibleCrUseOfTeamManager({
            error: Error()
