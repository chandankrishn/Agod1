System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, CCInteger, instantiate, UITransform, Input, input, TeamManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, TeamSelection;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TeamSelection", TeamSelection = (_dec = ccclass('TeamSelection'), _dec2 = property({
        ...
        start() {
          var startXpos = -(this.node.getComponent(UITransform).width * 0.1);
          var startYpos = -(this.node.getComponent(UITransform).height * 0.33);
          var tempNode = null;
        ...
        setUpDragons() {
          var dragons = (_crd && TeamManager === void 0 ? (_reportPossibleCrUseOfTeamManager({
            error: Error()
          }), TeamManager) : TeamManager).getInstance().getDragonImages();
          var tempNode = null;
          console.log();
          console.log("callled ", dragons.length);
          console.log("callled ", dragons.length);
          console.log((_crd && TeamManager === void 0 ? (_reportPossibleCrUseOfTeamManager({
            error: Error()
          }), TeamManager) : TeamManager).getInstance().getDragonImages().length);

          for (var i = 0; i < 3; i++) {
            console.log("Added Child");
            tempNode = instantiate(this.DragonsPrefab);
            this.DragonsParent.addChild(tempNode); // tempNode.getComponent(Sprite).spriteFrame = dragons[i];
          }
        }
        ...
        onTouchEnd() {} // update (deltaTime: number) {
        //     // [4]
        // }
